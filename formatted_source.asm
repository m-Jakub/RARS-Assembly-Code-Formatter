...
b_sntx:	.assciz "	# ERROR! Wrong line syntax\n"
...
read_inst:	# loop for packing the mnemonic
	...
	# skip newliine if before mnemonic - otherwise error
...
skip_lowercase:	
	...
	j	read_insst	# continue with loop
	# ============================= end of loop
...
find_x_before_arg:
	...
	li	t1, 20	# if shift was alrady set to 20 - 3rd argument just got encoded. Instructtion is finihsed
	beq	s6, t1, inst_end
...
check_minus:
	li	a4, 2047
	bne	s7, t4, convert_num	# positive number -> continue withh normal loop
